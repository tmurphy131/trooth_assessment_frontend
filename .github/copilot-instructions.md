...
- Backend base URL: `https://trooth-discipleship-api-dev.onlyblv.com` (dev environment)
...
5. Test with curl: `curl -H "Authorization: Bearer $TOKEN" https://trooth-discipleship-api-dev.onlyblv.com/health`
